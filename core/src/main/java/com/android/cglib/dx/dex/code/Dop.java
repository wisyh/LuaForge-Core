 ...
 * @param nextOpcode {@code Opcodes.isValid();} what opcode (by number) to try next
 ...
 * @param hasResult  whether this opcode uses a result register
 */
public record Dop(int opcode, int family, int nextOpcode, InsnFormat format, boolean hasResult) {
    /**
