 ...
 * @param branchingness the branchingness of this op; one of the {@code BRANCH_*}
 *                      constants in this class
 * @param isCallLike    whether this is a function/method call op or similar
 * @param nickname      {@code null-ok;} nickname, if specified (used for debugging)
 */
public record Rop(int opcode, Type result, TypeList sources, TypeList exceptions, int branchingness,
                  boolean isCallLike, String nickname) {
    /**
