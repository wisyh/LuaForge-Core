...
public final class CatchHandlerList extends FixedSizeList
    ...
    public boolean catchesAll() {
        ...
        return last.exceptionType().equals(CstType.OBJECT);
    }
     ...
     * @param handler       {@code >= 0;} exception handler address
     */
    public record Entry(CstType exceptionType, int handler) implements Comparable<Entry> {
        /**
